...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "* {\n  box-sizing: border-box;\n}\n\nbody {\n  margin: 0;\n  padding: 0;\n  background-image: url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ");\n}\n\n.headerContainer {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  border-bottom: 1px solid green;\n  background-color: green;\n}\n\nnav {\n  color: white;\n}\n\nul {\n  display: flex;\n  justify-content: space-evenly;\n  list-style-type: none;\n  padding-left: 0;\n}\n\nnav a:hover {\n  background-color: #000;\n}\n\nnav a {\n  color: white;\n  text-decoration: none;\n  font-size: 17px;\n  padding: 10px;\n}\n\n.textmain h1 {\n  margin-bottom: 40px;\n  text-align: center;\n  font-size: 50px;\n  background: linear-gradient(to right, #1bed65, #4ae971, #cf23cf, #eedd44);\n  -webkit-background-clip: text;\n  -webkit-text-fill-color: transparent;\n}\n\n.textmain {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  margin-top: 20vh;\n}\n\nbutton {\n  background-color: green;\n  padding: 16px;\n  width: 12%;\n  color: white;\n  border-radius: 10px;\n}\n\n/*    contact css */\n.contacthead {\n  color: white;\n  text-align: center;\n}\n\n.contactcontent p {\n  font-size: medium;\n  font-weight: bold;\n}\n\n.contactcontent {\n  background: linear-gradient(90deg, #020024 0%, #197909 39%, white 89%);\n  width: 700px;\n  border: 15px solid green;\n  padding: 50px;\n  margin: 100px;\n  border-radius: 30px;\n  color: white;\n  position: absolute;\n  top: 80%;\n  left: 40%;\n  transform: translate(-50%, -50%);\n}\n\ninput[type=text], select, textarea {\n  width: 100%;\n  padding: 12px;\n  border: 1px solid #ccc;\n  border-radius: 4px;\n  box-sizing: border-box;\n  margin-top: 6px;\n  margin-bottom: 16px;\n  resize: vertical;\n}\n\ninput[type=submit] {\n  background-color: #04AA6D;\n  color: white;\n  padding: 12px 20px;\n  border: none;\n  border-radius: 4px;\n  cursor: pointer;\n}\n\ninput[type=submit]:hover {\n  background-color: #45a049;\n}\n\n.container {\n  border-radius: 5px;\n  background-color: #f7f7f7;\n  padding: 20px;\n  color: black;\n}\n\n/* MENU CSS*/\n.project h2 {\n  text-align: center;\n  color: white;\n}\n\n/* Float four columns side by side */\n.column {\n  float: left;\n  width: 25%;\n  padding: 0 10px;\n  margin: auto;\n  flex: auto;\n}\n\n/* Remove extra left and right margins, due to padding */\n.row {\n  margin: 0 -5px;\n  border: 2px solid green;\n}\n\n/* Clear floats after the columns */\n.row:after {\n  content: \"\";\n  display: table;\n  clear: both;\n}\n\n/* Responsive columns */\n@media screen and (max-width: 600px) {\n  .column {\n    width: 100%;\n    display: block;\n    margin-bottom: 20px;\n  }\n}\n/* Style the counter cards */\n.card {\n  box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2);\n  padding: 16px;\n  text-align: center;\n  background-color: #f1f1f1;\n  border-radius: 10px;\n  box-shadow: 10px 10px;\n  display: flex;\n  transition: 0.4s;\n}\n\n.box {\n  background-color: #f1f1f1;\n  border: 2px solid #00ff2f;\n  padding: 10px;\n  width: 230px;\n  color: black;\n  border-radius: 15px;\n  border-color: #00ff2f;\n}\n\n.card:hover {\n  opacity: 0.8;\n}\n\n.row {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  flex-grow: 1;\n  gap: 20px;\n}\n\n.card h3 {\n  font-size: medium;\n  font-weight: bold;\n  font-family: \"Gill Sans\", \"Gill Sans MT\", Calibri, \"Trebuchet MS\", sans-serif;\n}\n\n.card-content {\n  flex-grow: 1;\n  /* Allow the text content to grow and occupy remaining space */\n}\n\n.card-image {\n  width: 100px;\n  /* Adjust the width as needed */\n  height: auto;\n  /* Maintain aspect ratio */\n  margin-right: 5px;\n  /* Add some spacing between image and text */\n}\n\n@media (max-width: 769px) {\n  button {\n    width: 50%;\n  }\n\n  .row {\n    flex-direction: column;\n  }\n}\n@media (max-width: 500px) {\n  .headerContainer {\n    flex-direction: column;\n    flex-grow: 1;\n    width: 100%;\n  }\n\n  header {\n    width: 100%;\n  }\n\n  .contactcontent {\n    width: 90%;\n    margin: 0 auto;\n  }\n}", "",{"version":3,"sources":["webpack://./src/styles/main.scss"],"names":[],"mappings":"AAKA;EACE,sBAAA;AAHF;;AAOA;EACE,SAAA;EACA,UAAA;EACA,yDAAA;AAJF;;AASA;EACE,aAAA;EACA,8BAAA;EACA,mBAAA;E
{\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n border-bottom: 1px solid green;\n background-color : green;\n\n}\n\n\nnav {\n\n  color: white;\n  \n}\n\nul {\n  display: flex;\n  justify-content: space-evenly;\n  list-style-type: none;\n  padding-left:0;\n}\n\nnav a:hover {\n  background-color: #000;\n}\nnav a{\n  color: white;\n  text-decoration: none;\n  font-size: 17px;\n  padding:10px;\n}\n\n.textmain h1{\n  margin-bottom: 40px;\n  text-align: center;\n  font-size: 50px;\n  background: linear-gradient(to right, #1bed65,\n #4ae971, #cf23cf, #eedd44);\n -webkit-background-clip: text;\n -webkit-text-fill-color: transparent;\n\n\n}\n\n.textmain {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  margin-top: 20vh;\n}\n\n\n\nbutton{\n  background-color: green;\n  padding: 16px;\n  width: 12%;\n  color:white;\n  border-radius: 10px;\n \n}\n\n/*    contact css */ \n\n\n.contacthead{\n  color :white;\n text-align: center;\n\n\n\n}\n\n.contactcontent p{\n  font-size: medium;\n  font-weight: bold;\n}\n\n.contactcontent {\n  background: linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(25,121,9,1) 39%, rgba(255,255,255,1) 89%);\n  width: 700px;\n  border: 15px solid green;\n  padding: 50px;\n  margin: 100px;\n  border-radius: 30px;\n  color:white;\n  position: absolute;\n          top: 80%;\n          left: 40%;\n          transform: translate(-50%, -50%);\n\n}\n\n\ninput[type=text], select, textarea {\n  width: 100%;\n  padding: 12px;\n  border: 1px solid #ccc;\n  border-radius: 4px;\n  box-sizing: border-box;\n  margin-top: 6px;\n  margin-bottom: 16px;\n  resize: vertical;\n}\n\ninput[type=submit] {\n  background-color: #04AA6D;\n  color: white;\n  padding: 12px 20px;\n  border: none;\n  border-radius: 4px;\n  cursor: pointer;\n}\n\ninput[type=submit]:hover {\n  background-color: #45a049;\n}\n\n.container {\n  border-radius: 5px;\n  background-color: #f7f7f7;\n  padding: 20px;\n  color:black;\n}\n\n\n\n\n\n\n\n\n\n/* MENU CSS*/\n\n.project h2{\n  text-align: center;\n  color:white;\n}\n\n\n\n\n/* Float four columns side by side */\n.column {\n  float: left;\n  width: 25%;\n  padding: 0 10px;\n  margin:auto;\n  flex: auto;\n}\n\n/* Remove extra left and right margins, due to padding */\n.row {margin: 0 -5px;\nborder: 2px solid green;\n\n}\n\n\n/* Clear floats after the columns */\n.row:after {\n  content: \"\";\n  display: table;\n  clear: both;\n}\n\n/* Responsive columns */\n@media screen and (max-width: 600px) {\n  .column {\n    width: 100%;\n    display: block;\n    margin-bottom: 20px;\n\n  }\n}\n\n/* Style the counter cards */\n.card {\n  box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2);\n  padding: 16px;\n \n  text-align: center;\n  background-color: #f1f1f1;\n  border-radius: 10px;\n\n  box-shadow: 10px 10px;\n  \n  display: flex;\n  transition: 0.4s;\n\n}\n\n\n\n.box {\n  background-color: #f1f1f1;\n  border: 2px solid #00ff2f;\n  padding: 10px;\n  width: 230px;\n  color: black;\n  border-radius: 15px;\n  border-color: #00ff2f;\n\n}\n\n.card:hover{\n  opacity: 0.8;\n}\n\n.row {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n flex-grow: 1;\n\n \n  gap: 20px;\n}\n\n.card h3{\n  font-size: medium;\n  font-weight: bold;\n  font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;\n} \n.card-content {\n  flex-grow: 1; /* Allow the text content to grow and occupy remaining space */\n}\n\n.card-image {\n  width: 100px; /* Adjust the width as needed */\n  height: auto; /* Maintain aspect ratio */\n  margin-right: 5px; /* Add some spacing between image and text */\n}\n\n@media (max-width:769px){\nbutton{\n    width: 50%;\n\n  }\n\n  .row{\n    flex-direction: column;\n  }\n\n\n}\n@media (max-width:500px){\n  .headerContainer{\n    flex-direction: column;\n    flex-grow: 1;\n    width:100%;\n    \n  }\nheader{\n  width:100%;\n}\n.contactcontent {\n  width: 90%;\n    \n  margin: 0 auto;\n}\n\n}\n\n\n\n\n"],"sourceRoot":""}]);
// Exports
...
/* harmony import */ var _assets_fries_png__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./assets/fries.png */ "./src/assets/fries.png");
/* harmony import */ var _assets_pizza_png__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./assets/pizza.png */ "./src/assets/pizza.png");
// DEMO JOKE APP
...
/******/ })()
;
//# sourceMappingURL=bundle8765b169ef43980629fb.js.map